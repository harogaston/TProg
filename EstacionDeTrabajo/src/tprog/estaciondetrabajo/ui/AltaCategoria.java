			...
			if (casillaPadre.isSelected()) {
				...
				if (categoriaPadreNodo != null) {
					...
					if (!ctrlProductos.seleccionarCategoriaPadre(categoriaPadre)) {
						JOptionPane.showMessageDialog(this, "Esa categoria tiene servicios asociados, escoja otra.", "Categoria padre inválida", JOptionPane.INFORMATION_MESSAGE);
					} else {
						if (!ctrlProductos.idCategoriaDisponible(categoriaNueva)) {
							JOptionPane.showMessageDialog(this, "El nombre escogido se encuentra en uso.", "Nombre inválido", JOptionPane.INFORMATION_MESSAGE);
						} else {
							ctrlProductos.altaCategoria();
							JOptionPane.showMessageDialog(this, "Categoria creada con exito.", "Éxito", JOptionPane.INFORMATION_MESSAGE);
							cargarDatos();
						}
					}
				} else {
					JOptionPane.showMessageDialog(this, "Debe seleccionar una categoria.", "Selección inválida", JOptionPane.INFORMATION_MESSAGE);
				}
			} else {
				if (!ctrlProductos.idCategoriaDisponible(categoriaNueva)) {
					JOptionPane.showMessageDialog(this, "El nombre escogido se encuentra en uso.", "Nombre inválido", JOptionPane.INFORMATION_MESSAGE);
					...
					ctrlProductos.altaCategoria();
					JOptionPane.showMessageDialog(this, "Categoria creada con éxito.", "Éxito", JOptionPane.INFORMATION_MESSAGE);
					cargarDatos();
				}
			}
		} else {
