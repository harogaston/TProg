...
//                System.out.println(nodo.toString());
    ...
    private void buttonConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonConfirmarActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Precio: El valor ingresado no es correcto", "Error", JOptionPane.ERROR_MESSAGE);
            okPrecio = false;
        }
        if (okPrecio) {
            ...
            if (ciudadOrigen != null) {
                ...
                if (checkBoxCiudadDestino.isSelected()) {
                    if (ciudadDestino != null) {
                        ...
                        JOptionPane.showMessageDialog(this, "Por favor seleccione una ciudad correcta de destino, o ninguna", "Error", JOptionPane.ERROR_MESSAGE);
                        return;
                    }
                }
                if (okDescripcion) {
