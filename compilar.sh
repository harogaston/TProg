...
# build y run estacion de trabajo, en paralelo con build de web app
ant -buildfile ./EstacionDeTrabajo/build.xml compile jar run | ant -buildfile ./WebApp/build.xml compile do-dist
