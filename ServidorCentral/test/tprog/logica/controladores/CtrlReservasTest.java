...
public class CtrlReservasTest {
    ...
    public void setUp() {
        try {
            ...
            fecha = new Date();
            Proveedor prov = new Proveedor("nick", "pass", "nom", "ap", "email", "imagen", fecha, "empresa", "webEmpresa");
            ...
            set.add(l1);
            Cliente jorge = new Cliente("alguien", "pass", "alg", "apellido", "email", "imagen", fecha);
