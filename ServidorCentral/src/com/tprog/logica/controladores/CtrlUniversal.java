    ...
    //Alta de Clientes
        ...
        try {
            ...
            DTCliente dtC = new DTCliente("oWood", "Oliver", "Wood", "quidditch28@gmail.com",
                directorioImagenes + "/imagenes/oWood.jpg", new Date(1988, 12, 28), new HashSet());
            mu.altaCliente(dtC);
            dtC = new DTCliente("eWatson", "Emma", "Watson", "e.watson@gmail.com",
                directorioImagenes + "/imagenes/eWatson.jpg", new Date(1990, 4, 15), new HashSet());
            mu.altaCliente(dtC);
        ...
        //AltaProveedores   
            DTProveedor dtP = new DTProveedor("tCook", "Tim", "Cook", "air.f@gmail.com",
                directorioImagenes + "/imagenes/tCook.jpg",
